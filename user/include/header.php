                        ...
                        <ul class="nav navbar-top-links pull-right">
                            ...
                            <li id="dropdown-user" class="dropdown">
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                    <span class="pull-right"> <img class="img-circle img-user media-object" src="../signup/<?php echo $img?>" alt="Profile Picture" style='margin-top: 5px;'> </span>
                                    <div class="username hidden-xs"><?php echo $fname." ".$lname;?></div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right with-arrow">
                                    ...
                                    <ul class="head-list">
                                        ...
                                        <li>
                                            <a href="update_profile.php"> <i class="fa fa-gear"></i> Update </a>
                                        </li>
                                        <li>
