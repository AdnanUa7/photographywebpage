                                                ...
                                                <a href="" data-toggle = "modal" data-target= "#exampleModaldep<?php echo $row['id'];?>" class="btn btn-primary" ><i class="fa fa-edit"></i></a>
                                                  ...
                                                  <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                      ...
                                                      <div class="modal-footer">
                                                        <a href="accept_booking.php?value=<?php echo $row['id'] ?>&email=<?php echo $email?>" class="btn btn-primary">YES</a>
                                                  ...
                                                  <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                      ...
                                                      <div class="modal-footer">
                                                        <a href="decline_booking.php?value=<?php echo $row['id'] ?>&email=<?php echo $email?>" class="btn btn-primary">YES</a>
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">NO</button>
                                                      </div>
                                                    </div>
                                                  </div>
