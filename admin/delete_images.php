                       ...
                       <div class="row">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">All Portfolio Images</h3>
                            </div>
                                ...
                                <table id="demo-dt-basic" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $row['img']?>" target="_blank"><img style="width: 50px;height: 50px;border-radius: 50%;" src="<?php echo $row['img']?>" alt=""></a></td>
                                            <td>
                                                  ...
                                                  <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                      ...
                                                      <div class="modal-footer">
                                                        <a href="delete_images_final.php?value=<?php echo $row['id'] ?>" class="btn btn-primary">YES</a>
