...
?>
                ...
                <?php
                    $data = mysqli_query($sql_con,"SELECT *from booking where status = '1'");
                    $row = mysqli_num_rows($data);

                    $data2 = mysqli_query($sql_con,"SELECT *from messages");
                                ...
                                <div class="panel">
                                    <div class="panel-body" style="padding: 0px 8px;">
                                        <div class="row text-center">
                                            ...
                                            <div class="col-sm-12">
                                                <h4 style="padding: 20px 0px;text-align: left;"><span class="counter">All Bookings</span></h4><span class="badge badge-light" style="position: absolute;top: 28px;right: 20px;"><?php echo $row?></span>
                                ...
                                <div class="panel">
                                    <div class="panel-body" style="padding: 0px 8px;">
                                        <div class="row text-center">
                                            ...
                                            <div class="col-sm-12">
                                                <h4 style="padding: 20px 0px;text-align: left;"><span class="counter">Contact Messages</span></h4><span class="badge badge-light" style="position: absolute;top: 28px;right: 20px;"><?php echo $row2?></span>
