            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    <div class="pageheader hidden-xs">
                        <h3><i class="fa fa-briefcase"></i> Declined Bookings </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="dashboard.php"> Home </a> </li>
                                <li class="active"> Declined Bookings </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                       ...
                       <div class="row">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">All Declined Bookings Details</h3>
                            </div>
                            <div class="panel-body">
                                <table id="demo-dt-basic" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                            $data = mysqli_query($sql_con,"SELECT *from booking where status='2'");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['b_date']?></td>
                                                ...
                                                <td style="background-color: #FF7753;color: #fff;font-weight: bolder;">Declined</td>
                                            <td>
                                                  ...
                                                  <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                      <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Delete Booking Record</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                          <span aria-hidden="true">&times;</span>
                                                        </button>
                                                      </div>
                                                      <div class="modal-body">
                                                        Do you really want to delete this booking record?
                                                      </div>
                                                      <div class="modal-footer">
                                                        <a href="delete_booking.php?value=<?php echo $row['id'] ?>" class="btn btn-primary">YES</a>
