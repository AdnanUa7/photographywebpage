            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    <div class="pageheader hidden-xs">
                        <h3><i class="fa fa-briefcase"></i> Approved Bookings </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="dashboard.php"> Home </a> </li>
                                <li class="active"> Approved Bookings </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                       ...
                       <div class="row">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">All Approved Bookings Details</h3>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['b_date']?></td>
                                                ...
                                                <td style="background-color: #93C069;color: #fff;font-weight: bolder;">Approved</td>
                                            <td>
