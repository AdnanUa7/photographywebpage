                            ...
                            <div class="col-lg-12">
                               <div class="panel">
                                    ...
                                    <span class="pull-right pad-20">
                                      <a href="upload_images.php"><button class="btn btn-default" type="button"><i class="fa fa-upload"></i> Upload</button></a>
                                      <a href="delete_images.php"><button class="btn btn-default" type="button"><i class="fa fa-trash"></i> Trash</button></a>
                                    </span>
                                  </div>
